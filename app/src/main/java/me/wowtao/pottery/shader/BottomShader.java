...
public class BottomShader extends PotteryShader{
	...
	private static final float[] diffuseL2 = new float[]{0.9f, 0.9f, 0.9f, 1.0f};
	...
	public BottomShader(String vertexShader, String fragShader, Resources resources, float offset) {
